...
CPP_FILES = src/matrix.cc src/program.cc src/input.cc src/lib/obj.cc src/utils.cc src/shader_func.cc src/textures.cc
CPP_FILES +=
HXX_FILES = src/matrix.hh src/program.hh src/object_vbo.hh src/input.hh src/camera.hh src/mouse.hh src/lib/obj.hh src/utils.hh src/shader_func.hh src/textures.hh
HXX_FILES +=
